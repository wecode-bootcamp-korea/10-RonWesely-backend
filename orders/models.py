...
class OrderItem(models.Model):
    ...
    product_sizes  = models.ForeignKey('products.ProductSize', on_delete=models.SET_NULL, null=True)
    blade_products = models.ForeignKey('products.BladeProduct', on_delete=models.SET_NULL, null=True)
    product_colors = models.ForeignKey('products.ProductColor', on_delete=models.SET_NULL, null=True)
