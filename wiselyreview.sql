...
CREATE TABLE `blade_products` (
  `id` int NOT NULL AUTO_INCREMENT,
  `price` decimal(10,2) NOT NULL,
  `product_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `blade_products_product_id_e973e384_fk_products_id` (`product_id`),
  CONSTRAINT `blade_products_product_id_e973e384_fk_products_id` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`)
...
CREATE TABLE `order_images` (
  ...
  `blade_products_id` int DEFAULT NULL,
  `products_colors_id` int DEFAULT NULL,
  `products_sizes_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `order_images_blade_products_id_2bc4f039_fk_blade_products_id` (`blade_products_id`),
  KEY `order_images_products_colors_id_49e51158_fk_products_colors_id` (`products_colors_id`),
  KEY `order_images_products_sizes_id_ac60b751_fk_products_sizes_id` (`products_sizes_id`),
  CONSTRAINT `order_images_blade_products_id_2bc4f039_fk_blade_products_id` FOREIGN KEY (`blade_products_id`) REFERENCES `blade_products` (`id`),
  CONSTRAINT `order_images_products_colors_id_49e51158_fk_products_colors_id` FOREIGN KEY (`products_colors_id`) REFERENCES `products_colors` (`id`),
  CONSTRAINT `order_images_products_sizes_id_ac60b751_fk_products_sizes_id` FOREIGN KEY (`products_sizes_id`) REFERENCES `products_sizes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_items` (
  ...
  `product_colors_id` int DEFAULT NULL,
  `product_sizes_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `order_items_blade_products_id_be474d35_fk_blade_products_id` (`blade_products_id`),
  KEY `order_items_order_id_412ad78b_fk_orders_id` (`order_id`),
  KEY `order_items_product_colors_id_846fd131_fk_products_colors_id` (`product_colors_id`),
  KEY `order_items_product_sizes_id_cb70b93c_fk_products_sizes_id` (`product_sizes_id`),
  CONSTRAINT `order_items_blade_products_id_be474d35_fk_blade_products_id` FOREIGN KEY (`blade_products_id`) REFERENCES `blade_products` (`id`),
  CONSTRAINT `order_items_order_id_412ad78b_fk_orders_id` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`),
  CONSTRAINT `order_items_product_colors_id_846fd131_fk_products_colors_id` FOREIGN KEY (`product_colors_id`) REFERENCES `products_colors` (`id`),
  CONSTRAINT `order_items_product_sizes_id_cb70b93c_fk_products_sizes_id` FOREIGN KEY (`product_sizes_id`) REFERENCES `products_sizes` (`id`)
...
CREATE TABLE `orders` (
  ...
  KEY `orders_shipping_id_b3ab186f_fk_shippings_id` (`shipping_id`),
  ...
  CONSTRAINT `orders_shipping_id_b3ab186f_fk_shippings_id` FOREIGN KEY (`shipping_id`) REFERENCES `shippings` (`id`),
...
CREATE TABLE `path_results` (
  `id` int NOT NULL AUTO_INCREMENT,
  `path_lists_id` int DEFAULT NULL,
  `users_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `path_results_path_lists_id_cbd0941e_fk_paths_id` (`path_lists_id`),
  KEY `path_results_users_id_58ebc1ae_fk_users_id` (`users_id`),
  CONSTRAINT `path_results_path_lists_id_cbd0941e_fk_paths_id` FOREIGN KEY (`path_lists_id`) REFERENCES `paths` (`id`),
  CONSTRAINT `path_results_users_id_58ebc1ae_fk_users_id` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `products_sizes` (
  ...
  CONSTRAINT `products_sizes_skin_type_id_d1fbc386_fk_skin_types_id` FOREIGN KEY (`skin_type_id`) REFERENCES `skin_types` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shippings` (
  ...
  `user_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `shippings_user_id_4d31e245_fk_users_id` (`user_id`),
  CONSTRAINT `shippings_user_id_4d31e245_fk_users_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`),
  KEY `users_gender_id_5b939083` (`gender_type_id`),
  CONSTRAINT `users_gender_type_id_121f9ad7_fk_genders_id` FOREIGN KEY (`gender_type_id`) REFERENCES `genders` (`id`)
...
-- Dump completed on 2020-07-31 14:48:31
